...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51291a77b2f74029969b0e5c56b486f3) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["FormatExt"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "javascript-parser"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_interface_patterns =
                        [
     ...
     oasis_digest = Some "\178\014\214\160\t\248\226\171'\148\190\0124 _\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
